        ...
        <View style={styles.cardWrapper}>
          ...
          <View style={styles.glassCard}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>Toplam Kaza Namazı</Text>
...
const styles = StyleSheet.create({
  ...
  indicatorContainer: { marginTop: 4 },
  indicatorBackground: {
    height: 6,
  ...
  prayersContainer: { gap: 12, paddingHorizontal: 16 },
  prayerItem: {
    borderRadius: 12,
    overflow: "hidden",
    shadowColor: "#000",
  ...
  prayerCountText: { fontWeight: "400" },
  dropdownContent: {
    borderTopWidth: 1,
  },
  prayerListItem: {
  ...
  prayerListItemLast: { borderBottomWidth: 0 },
  prayerListItemDate: {
    fontSize: 14,
    fontWeight: "500",
  },
